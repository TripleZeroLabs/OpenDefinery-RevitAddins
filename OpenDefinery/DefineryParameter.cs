...
namespace OpenDefinery
{
    public class DefineryParameter
    {
        ...
        /// <summary>
        /// Retrieve DefineryParameter objects which have a specific GUID.
        /// </summary>
        ...
        /// <returns></returns>
        public static ObservableCollection<DefineryParameter> SetCollections(Definery definery, ObservableCollection<DefineryParameter> parameters)
        {
            // Set the Collections
            var updatedParams = new ObservableCollection<DefineryParameter>();
        ...
        /// <returns></returns>
        public static ObservableCollection<DefineryParameter> Search(Definery definery, string searchQuery, int itemsPerPage, int offset, bool resetTotals)
        {
            var listOfParams = new List<DefineryParameter>();
        ...
        public static bool RemoveCollection(Definery definery, DefineryParameter param, int removedCollectionId)
        {
            // Instantiate a list of Collection IDs as strings
            var collectionIds = new List<string>();
